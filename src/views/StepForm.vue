...
<template>
    <div class="step-home-page">
            ...
            <el-form :model="form" label-width="100px" ref="formRef" :rules="rules" label-position="top">
                <div v-show="active === 0">
                    ...
                    <el-form-item label="收款账户" prop="type">
                        <el-input v-model="form.acceptAccount">
                            <template #prepend>
                                <el-select v-model="form.type" style="width: 115px">
                ...
                <div v-show="active === 1">
                    ...
                    <el-form-item label="支付密码" prop="name">
                        <el-input v-model="form.pass" type="passworld" placeholder="请输入" />
                    </el-form-item>
                </div>
                <div v-show="active === 2">
        ...
        <div class="foot">
            <el-button v-show="active === 1" style="margin-top: 12px" @click="preview">上一步</el-button>
            <el-button v-show="active === 0" style="margin-top: 12px" @click="next" type="primary">下一步</el-button>
            <el-button v-show="active === 1" style="margin-top: 12px" @click="next" type="primary">提交</el-button>
